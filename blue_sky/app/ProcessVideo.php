        ...
        try {
            ...
            if ($regionId) {
                ...
                if ($infoUsersLocationUf === 'CE') {
                    $molduraPath = public_path('fortalezaQRCode1080_16_05.mov');
                    $moldura320Path = public_path('fortalezaQRCode448_16_05.mov');
                } elseif ($infoUsersLocationUf === 'PE') {
                    $molduraPath = public_path('recifeQRCode1080_16_05.mov');
                    $moldura320Path = public_path('recifeQRCode448_16_05.mov');
                } else {
                    $molduraPath = public_path('rjQRCode1080_16_05.mov');
                    $moldura320Path = public_path('rjQRCode448_16_05.mov');
                }
